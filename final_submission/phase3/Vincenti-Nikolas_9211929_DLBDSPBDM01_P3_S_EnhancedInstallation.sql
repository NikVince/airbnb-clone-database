-- ==============================================
-- Airbnb Database Enhanced Installation Script - PHASE 3
-- Enhanced with additional data to ensure 20+ entries per table
-- Phase 3: Final Implementation with Complete Data Volume
...
(6, 'date_change', '2024-07-08 to 2024-07-10', '2024-07-09 to 2024-07-11', 'Guest requested one day later', '2024-06-15 14:00:00', 6),
(7, 'guest_count_change', '1 guest', '2 guests', 'Guest added companion', '2024-07-05 10:00:00', 7),
(8, 'price_adjustment', '360.00', '340.00', 'Early bird discount applied', '2024-07-01 09:00:00', 8),
(9, 'date_change', '2024-08-14 to 2024-08-18', '2024-08-15 to 2024-08-19', 'Guest requested one day later', '2024-07-20 11:00:00', 9),
(10, 'guest_count_change', '2 guests', '3 guests', 'Guest added family member', '2024-08-10 15:00:00', 10),
(11, 'price_adjustment', '2100.00', '2000.00', 'Monthly discount applied', '2024-08-01 12:00:00', 11),
(12, 'date_change', '2024-09-22 to 2024-09-29', '2024-09-23 to 2024-09-30', 'Guest requested one day later', '2024-09-01 16:00:00', 12),
(13, 'guest_count_change', '4 guests', '5 guests', 'Guest added friend', '2024-09-15 13:00:00', 13),
(14, 'price_adjustment', '135.00', '120.00', 'Student discount applied', '2024-09-10 10:00:00', 14),
(15, 'date_change', '2024-10-30 to 2024-11-02', '2024-10-31 to 2024-11-03', 'Guest requested one day later', '2024-10-15 14:00:00', 15),
(16, 'guest_count_change', '2 guests', '3 guests', 'Guest added partner', '2024-10-25 11:00:00', 16),
(17, 'price_adjustment', '330.00', '300.00', 'Loyalty discount applied', '2024-10-20 09:00:00', 17),
(18, 'date_change', '2024-11-15 to 2024-11-18', '2024-11-16 to 2024-11-19', 'Guest requested one day later', '2024-11-01 12:00:00', 18),
(19, 'guest_count_change', '3 guests', '4 guests', 'Guest added child', '2024-11-10 15:00:00', 19),
(20, 'price_adjustment', '210.00', '180.00', 'Group discount applied', '2024-11-05 08:00:00', 20);
...
(11, 11, 11, 'completed', 'Full transaction completed successfully', '2024-12-10 08:00:00'),
(12, 12, 12, 'completed', 'Full transaction completed successfully', '2024-12-30 08:00:00'),
(13, 13, 13, 'completed', 'Full transaction completed successfully', '2025-01-15 08:00:00'),
(14, 14, 14, 'completed', 'Full transaction completed successfully', '2025-01-30 08:00:00'),
(15, 15, 15, 'completed', 'Full transaction completed successfully', '2025-02-15 08:00:00'),
(16, 16, 16, 'completed', 'Full transaction completed successfully', '2025-02-28 08:00:00'),
(17, 17, 17, 'completed', 'Full transaction completed successfully', '2025-03-15 08:00:00'),
(18, 18, 18, 'completed', 'Full transaction completed successfully', '2025-03-30 08:00:00'),
(19, 19, 19, 'completed', 'Full transaction completed successfully', '2025-04-10 08:00:00'),
(20, 20, 20, 'completed', 'Full transaction completed successfully', '2025-04-25 08:00:00');

-- ==============================================
-- COMPLETION MESSAGE
-- ==============================================

SELECT 'Enhanced sample data insertion successful!' AS Status,
       'All 27 tables populated with 20+ entries per table' AS Description,
...
-- Show table counts with 20+ entries verification
SELECT 
    TABLE_NAME,
    TABLE_ROWS,
    CASE 
        WHEN TABLE_ROWS >= 20 THEN '✅ MEETS REQUIREMENT'
